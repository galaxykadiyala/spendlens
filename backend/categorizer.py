...
CATEGORY_RULES = {
    "Fuel": ["hpcl", "hp pay", "shell", "filling station", "fuel station", "petrol",
             ...
             "hp pay direct", "indian oil corpo", "petro service"],
    ...
    "Medical": ["apollo", "medplus", "pharmacy", "hospital", "dental", "clinic",
                ...
                "mosaic wellness", "manmatters", "kumon", "superhealth", "qikwell"],
    "Education": ["nps trust", "school", "tuition", "growthx", "simpliaxis"],
    "Shopping": ["amazon", "flipkart", "myntra", "nykaa", "lulu international",
                 ...
                 "reliance digital", "apple india", "eureka forbes", "uniqlo", "lifelong",
                 "deena uniform"],
    "Jewellery": ["jeweller", "thangamaligai", "ramala", "malabar", "tanishq",
                  "kalyan jewell", "joyalukkas", "senco gold", "pc jeweller",
                  "bluestone", "caratlane"],
    "Health & Wellness": ["kashayam ayurveda", "body craft", "chillchemy", "o2 spa", "vlcc",
                          "reboot", "ultrahuman", "sushrut ayurved", "nutrition"],
    "Transport": ["uber", "ola", "parking", "metro", "cab", "park plus", "fastag"],
    "Travel": ["emirates", "etihad", "indigo", "vistara", "air india", "spicejet",
               "akasa air", "oebb", "wien ticket", "jetpac", "vfs global",
               "mmt hotel", "makemytrip", "goibibo", "cleartrip"],
    ...
    "Subscriptions": ["netflix", "hotstar", "spotify", "amazon prime", "mflxnl",
                      ...
                      "claude.ai", "anthropic"],
    "Personal Care": ["loreal", "hair", "salon", "grooming", "foxtale"],
    ...
    "Insurance": ["acko", "lic", "insurance", "star health"],
